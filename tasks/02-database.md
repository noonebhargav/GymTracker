...
## Acceptance Criteria
- [ ] SQLite tables created: exercises, routines, workout_logs, settings
- [ ] 1,324 exercises seeded from seed_data.json
- [ ] Explore tab shows "1,324 exercises loaded"
- [ ] App relaunch does not re-seed
